...
bestfs12(Dest,LLA,Cam,Custo,Ligacoes):-
	...
	((Act==Dest,!,bestfs12(Dest,[LA|LLA1],Cam,Custo,Ligacoes))
	 ;
	 (
	  findall((C,[X|LA]),(ligacao(Act,X,FL1,FL2,FR1,FR2),C is (FL1+FL2)/2 + FR1+FR2,
	  \+member(X,LA)),Novos),
	  Novos\==[],!,
...
calcula_custo([Act,X],C,Ligacoes):-Ligacoes>0,ligacao(Act,X,FL1,FL2,FR1,FR2),FLM is (FL1+FL2)/2,FRT is FR1+FR2,
	FRT>200,C is (FLM/2)+(50).
calcula_custo([Act,X],C,Ligacoes):-Ligacoes>0,ligacao(Act,X,FL1,FL2,FR1,FR2),FLM is (FL1+FL2)/2,FRT is FR1+FR2,
	FRT>=0,C is (FLM/2)+(25+(FRT/8)).
calcula_custo([Act,X],C,Ligacoes):-Ligacoes>0,ligacao(Act,X,FL1,FL2,FR1,FR2),FLM is (FL1+FL2)/2,FRT is FR1+FR2,
	FRT>=(-200),C is (FLM/2)+(25-(abs(FRT)/8)).
calcula_custo([Act,X],C,Ligacoes):-Ligacoes>0,ligacao(Act,X,FL1,FL2,FR1,FR2),FLM is (FL1+FL2)/2,FRT is FR1+FR2,
	FRT<(-200),C is (FLM/2).
