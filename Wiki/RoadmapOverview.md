...
Este SAD descreve a arquitetura de software do sistema a desenvolver por solicitação da  Graphs4Social, S.A de forma a fornecer aplicações de manipulação e visualização de grafos de redes sociais.

Este SAD é desenvolvido num contexto académico de ensino-aprendizagem (no 5º semestre da LEI no ano letivo 2021-2022), em que várias competências estão a ser adquiridas ao longo do semestre pelos/as estudantes, ao mesmo tempo que desenvolvem o sistema.
