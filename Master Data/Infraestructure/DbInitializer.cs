...
namespace DDDSample1.Infrastructure
{
    public static class DbInitializer
    {
        public static void Initialize(DDDSample1DbContext context)
        {
            ...
            var jogadores = new Jogador[] { new Jogador(p1.Id), new Jogador(p2.Id), new Jogador(p3.Id) };
            ...
            Introducao intro = new Introducao(jogadores[2].Id,jogadores[1].Id,jogadores[0].Id,"Pendente");
