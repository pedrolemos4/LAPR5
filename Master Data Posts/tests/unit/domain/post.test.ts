...
describe('post test', function () {
    ...
    it('should create post', async function () {
        let body = {"id":"123", "description":'post1', "email":'teste@gmail.com', "listaComentarios":[] ,"likes":[], "dislikes":[]}
    ...
    it('should not create post - no description', async function () {
        let body = {"id":"123", "description":'', "email":'teste@gmail.com', "listaComentarios":[] ,"likes":[], "dislikes":[]}
        const post = Post.create(body as IPostDTO);
